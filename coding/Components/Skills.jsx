...
const PizzaList = () => {
  return (
    <Box backgroundImage="url(/assets/star.gif)"
     py="10">
      ...
      <Grid m="auto" templateColumns={{sm:'repeat(2, 1fr)',lg:"repeat(3, 1fr)",md:"repeat(3, 1fr)"}} gap={6}>
        ...
        <GridItem >
           ...
           <Box textAlign="center" bg="white" padding="2" borderRadius="10" style={{boxShadow: `rgba(0, 0, 0, 0.35) 0px 5px 15px`}}> <Image m="5"  h={40} src={ele.src} alt={ele.linkto} />
